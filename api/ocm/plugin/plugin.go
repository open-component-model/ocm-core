...
import (
	...
	accval "ocm.software/ocm-core/api/ocm/plugin/ppi/cmds/accessmethod/validate"
	"ocm.software/ocm-core/api/ocm/plugin/ppi/cmds/action"
	"ocm.software/ocm-core/api/ocm/plugin/ppi/cmds/action/execute"
	...
	merge "ocm.software/ocm-core/api/ocm/plugin/ppi/cmds/mergehandler/execute"
	"ocm.software/ocm-core/api/ocm/plugin/ppi/cmds/upload"
	"ocm.software/ocm-core/api/ocm/plugin/ppi/cmds/upload/put"
	uplval "ocm.software/ocm-core/api/ocm/plugin/ppi/cmds/upload/validate"
	"ocm.software/ocm-core/api/ocm/plugin/ppi/cmds/valueset"
	vscompose "ocm.software/ocm-core/api/ocm/plugin/ppi/cmds/valueset/compose"
	vsval "ocm.software/ocm-core/api/ocm/plugin/ppi/cmds/valueset/validate"
