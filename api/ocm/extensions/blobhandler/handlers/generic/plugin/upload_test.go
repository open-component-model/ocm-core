...
import (
	...
	"ocm.software/ocm-core/api/ocm/extensions/blobhandler"
	"ocm.software/ocm-core/api/ocm/extensions/blobhandler/handlers/generic/plugin"
	"ocm.software/ocm-core/api/ocm/extensions/repositories/ctf"
	plugin2 "ocm.software/ocm-core/api/ocm/plugin"
	"ocm.software/ocm-core/api/ocm/plugin/config"
