...
pkgprefix="ocm.software/ocm-core"

log "Format with gci" # gci write --custom-order --skip-generated -s standard -s blank -s dot -s default -s "Prefix(ocm.software/ocm-core)"
